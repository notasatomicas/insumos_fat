  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Funcionalidad en Desarrollo</h1>
        <button type="button" class="ms-auto border-0 focus-none" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-circle-xmark" style="color: red !important;"></i></button>
      </div>
      <div class="modal-body">
        Estamos desarrollando esta funcionalidad. ¡Gracias por tu paciencia!
      </div>
