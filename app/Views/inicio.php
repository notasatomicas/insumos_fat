  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./public/assets/img/1920x1080_1.jpg" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="./public/assets/img/1920x1080_2.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>Calidad desde el primer contacto</h5>
          <p>Directamente de la fabrica a tu hogar, satisfaccion asegurada</p>
        </div>
      </div>
      <div class="carousel-item">
        <img src="./public/assets/img/1920x1080_3.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
  ...
  <div class="products my-4 mx-2">
        ...
        <div class="row">
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card">
                    <a href="error" target="_blank"><img src="public/assets/img/productos/p1.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
                            <div class="card-title h5">Iphone 13</div>
                        </a>
                        <div class="rating"><span><i class="fas fa-star"></i></span><span><i class="fas fa-star"></i></span><span><i class="far fa-star"></i></span><span><i class="far fa-star"></i></span><span><i class="far fa-star"></i></span><span> 12
                                reviews</span></div>
            ...
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card"><a href="error" target="_blank"><img src="public/assets/img/productos/p2.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
            ...
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card"><a href="error" target="_blank"><img src="public/assets/img/productos/p3.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
            ...
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card"><a href="error" target="_blank"><img src="public/assets/img/productos/p4.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
            ...
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card"><a href="error" target="_blank"><img src="public/assets/img/productos/p5.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
            ...
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card"><a href="error" target="_blank"><img src="public/assets/img/productos/p6.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
            ...
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card"><a href="error" target="_blank"><img src="public/assets/img/productos/p7.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
            ...
            <div class="mb-3 col-lg-3 col-md-4 col-sm-6">
                <div class="card"><a href="error" target="_blank"><img src="public/assets/img/productos/p8.jpg" class="card-img-top" alt="Nike Slim shirt"></a>
                    <div class="card-body"><a href="error" target="_blank">
