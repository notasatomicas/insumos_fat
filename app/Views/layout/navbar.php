      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav nav-pills justify-content-end flex-grow-1 pe-3">
          ...
          <li class="<?= esActivo('inicio', $segment) ? 'nav-item mx-5 mx-sm-4 mx-lg-0' : 'hvr-underline-from-center nav-item mx-5 mx-sm-4 mx-lg-0' ?>">
            <a class="nav-link text-center me-lg-2 px-2 px-xl-4 <?= esActivo('inicio', $segment) ? 'active' : '' ?>" href="<?= base_url('inicio') ?>">
          ...
          <li class="<?= esActivo('comercializacion', $segment) ? 'nav-item mx-5 mx-sm-4 mx-lg-0' : 'hvr-underline-from-center nav-item mx-5 mx-sm-4 mx-lg-0' ?>">
            <a class="nav-link text-center me-lg-2 px-2 px-xl-4 <?= esActivo('comercializacion', $segment) ? 'active' : '' ?>" href="<?= base_url('comercializacion') ?>">
          ...
          <li class="<?= esActivo('nosotros', $segment) ? 'nav-item mx-5 mx-sm-4 mx-lg-0' : 'hvr-underline-from-center nav-item mx-5 mx-sm-4 mx-lg-0' ?>">
            <a class="nav-link text-center me-lg-2 px-2 px-xl-4 <?= esActivo('nosotros', $segment) ? 'active' : '' ?>" href="<?= base_url('nosotros') ?>">
          ...
          <li class="<?= esActivo('contacto', $segment) ? 'nav-item mx-5 mx-sm-4 mx-lg-0' : 'hvr-underline-from-center nav-item mx-5 mx-sm-4 mx-lg-0' ?>">
            <a class="nav-link text-center me-lg-2 px-2 px-xl-4 <?= esActivo('contacto', $segment) ? 'active' : '' ?>" href="<?= base_url('contacto') ?>">
          ...
          <li class="nav-item mx-5 mx-sm-4 mx-lg-0">
            <?php if (session()->get('id_usuario') || session()->get('isLoggedIn')): ?>
              <!-- LOGOUT -->
              <a class="nav-link text-center me-lg-2 px-2 px-xl-4" href="<?= base_url('auth/logout') ?>" style="background-color: #dc3545 !important; color: white !important;">
                <i class="ms-md-0 me-1 fa-solid fa-sign-out-alt"></i>
                Cerrar sesión
              </a>
            <?php else: ?>
              <!-- LOGIN -->
              <a class="nav-link text-center me-lg-2 px-2 px-xl-4 <?= esActivo('auth', $segment) ? 'active' : '' ?>" href="<?= base_url('auth') ?>" style="background-color:rgb(24, 167, 155) !important; color: white !important;">
