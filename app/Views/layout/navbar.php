<nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Offcanvas navbar large">
    <div class="container-fluid">
      ...
      <a class="navbar-brand animate__bounceIn" href="./">
        <img src="./public/assets/img/icon.png" alt="Logo" width="57" height="50" class="d-inline-block">
        ...
        <div class="offcanvas-body">
          ...
          <ul class="navbar-nav nav-pills justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item mx-5 mx-sm-4 mx-lg-0">
                <!-- lo de adentro es lo que determina que tan grande es la parte azul, es decir el px-x es lo que lo hace -->
                 <!-- a pesar de ello arriba en cada li estuve dandole un margen para que se adecue mas y tenga mejor aspecto -->
                  <a id="btn_nav_inicio" class="hvr-underline-from-center nav-link text-center px-4 active" href="./inicio">
              ...
              <li class="nav-item mx-5 mx-sm-4 mx-lg-0">
                  <a id="btn_nav_comercializacion" class="hvr-underline-from-center nav-link text-center px-4" href="./comercializacion">
              ...
              <li class="nav-item mx-5 mx-sm-4 mx-lg-0">
                  <a id="btn_nav_nosotros" class="hvr-underline-from-center nav-link text-center px-4" href="./nosotros">
              ...
              <li class="nav-item mx-5 mx-sm-4 mx-lg-0">
                  <a id="btn_nav_contacto" class="hvr-underline-from-center nav-link text-center px-4" href="./contacto">
              ...
              <li class="nav-item mx-5 mx-sm-4 mx-lg-0">
                  <a id="btn_nav_tyc" class="hvr-underline-from-center nav-link text-center px-4" href="./terminos">
