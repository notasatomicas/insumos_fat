<main class="container-fluid">
  <h1 class="my-4 text-center">Nuestro equipo</h1>
    ...
    <div class="row align-items-center justify-content-around">
      <div class="col-11 col-md-3 rounded-4 my-2" style="border: 1px solid black;">
        <div class="d-flex align-items-center justify-content-center mt-4">
          <img src="https://i.pinimg.com/280x280_RS/18/d6/0a/18d60afe334e2434eaae0d6ad04b0649.jpg" alt="" class="rounded-circle" width="140" height="140">
        </div>
  ...
  <h1 class="my-4 text-center">Nuestros establecimientos</h1>
